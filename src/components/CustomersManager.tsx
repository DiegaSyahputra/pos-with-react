...
//             Kelola profil pelanggan dan pantau perolehan poin reward.
//           </p>
//         </div>
...
//                 <th className="px-4 py-3.5 text-center">Poin Reward</th>
...
export const CustomersManager: React.FC<CustomersManagerProps> = ({
  ...
  // Pagination sisi klien — daftar pelanggan bisa terus bertambah,
  // jadi tidak semuanya dirender sekaligus.
        ...
        {!loading && customers.length > 0 && (
          <div className="flex items-center justify-between px-4 py-3 border-t border-slate-800 text-xs text-slate-400">
            <span>
              ...
              {Math.min(currentPage * ITEMS_PER_PAGE, customers.length)} dari{" "}
