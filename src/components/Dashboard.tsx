...
//             Pantau ringkasan transaksi, stok menu, dan performa cafe hari ini
//           </p>
//         </div>
...
//                     <td className="px-4 py-3 font-mono font-semibold text-indigo-500">
//                       {tx.invoiceNo}
//                     </td>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 glass-card p-6">
          ...
          <div className="space-y-4">
            {(() => {
              // Dihitung sekali di sini, bukan berulang di setiap iterasi
              // .map() di bawah (sebelumnya recompute per baris kategori).
              const maxRevenue = Math.max(
                ...(stats?.categoryBreakdown?.map(
                  (c: any) => c.totalRevenue,
                ) || [0]),
                1,
              );
              const colors = [
              ...
              return stats?.categoryBreakdown?.map((cat: any, idx: number) => {
                const percent = Math.round(
                  (cat.totalRevenue / maxRevenue) * 100,
                );
                return (
                  <div
                    key={idx}
